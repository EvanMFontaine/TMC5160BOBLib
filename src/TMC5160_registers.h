	...
	#define TMCRhino_OTP_PROG		0x06
	#define TMCRhino_OTP_READ		0x07
	#define TMCRhino_FACTORY_CONF	0x08
	#define TMCRhino_SHORT_CONF		0x09
	#define TMCRhino_DRV_CONF		0x0A
	#define TMCRhino_GLOBAL_SCALER	0x0B
	#define TMCRhino_OFFSET_READ	0x0C

	#define TMCRhino_IHOLD_IRUN 	0x10
	#define TMCRhino_TPOWERDOWN 	0x11
	...
	#define TMCRhino_TZEROWAIT  	0x2C
	...
	#define TMCRhino_ENC_DEVIATION	0x3D
	...
	#define TMCRhino_PWMSCALE 		0x71
	#define TMCRhino_PWM_AUTO 		0x72
	...
	#define TMCRhino_SW_STOPL_POLARITY 0x0004
