// This example shows how to you TMC5160 BOB with teensy 3.6 in a simple case : usage of velocity mode.
...
void setup() {
  ...
  m.dontBeQuiet();//normal mode, stealthchop2 not activated.
  ...
  m.setStepRes(STEP128);//Step resolution. Other available are STEP256 (default), STEP64, STEP32, STEP16, STEP8, STEP4, STEP2 and FULLSTEP
